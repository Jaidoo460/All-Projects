...
SELECT city_name, state_abbreviation FROM city WHERE stste_abbreviation != 'CA';
...
SELECT state_name, census_region FROM state WHERE census_region IS null; 
...
SELECT city_name, area AS land, population AS people FROM city WHERE area < 25 AND population > 100000;
